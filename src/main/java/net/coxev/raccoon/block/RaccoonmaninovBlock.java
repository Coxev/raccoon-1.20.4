...
public class RaccoonmaninovBlock extends HorizontalFacingBlock {
    ...
    public static final MapCodec<RaccoonmaninovBlock> CODEC = RaccoonmaninovBlock.createCodec(RaccoonmaninovBlock::new);
    public static final DirectionProperty FACING = HorizontalFacingBlock.FACING;
    protected static final VoxelShape SHAPE = Block.createCuboidShape(4.0, 0.0, 4.0, 12.0, 12.0, 12.0);


    public MapCodec<? extends RaccoonmaninovBlock> getCodec() {
        return CODEC;
    }
