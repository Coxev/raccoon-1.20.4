...
public enum ModArmorMaterials implements ArmorMaterial {
    MALACHITE("malachite", 33, new int[] { 3, 8, 6, 3 }, 10,
            SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 1.0f, 0.1f, () -> Ingredient.ofItems(ModItems.MALACHITE));
    ...
    public String getName() {
        return Raccoon.MOD_ID + ":" + this.name;
    }
